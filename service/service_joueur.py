"""module service joueur

Modélise ServiceJoueur, un singleton qui contient toutes les méthodes
utiles pour un utilisateur de type joueur.
"""
...
class ServiceJoueur(metaclass=Singleton):
    ...
    Singleton, utilisé par les vues du joueur
    """
    ...
    def creation_personnage(self, perso):
        ...
        Génère l'id du personnage et notifie à la base de données les
        différentes informations du personnage en question.
    ...
    def desinscription_personnage(self, id_perso, id_partie, pseudo_j):
        ...
        -------
        bool
            Retourne un True si la désinscription a bien été réalisée, sinon False.
            Notifie les changements à la base de données.
        """
    ...
    def parties_dispos_creneau(self, id_creneau):
        """ Accès à la liste des parties pour lesquels il y a moins de 4 joueurs,
        à l'aide d'un créneau.
        ...
        parties_ok = [partie for partie in parties if len(
            partie.liste_persos) < 4]
        return parties_ok

    def persos_niv_sup_a(self, joueur, niveau):
        """ Accès à la liste des personnages du joueur dont le niveau est supérieur
        ou égal à un niveau minimum requis
        ...
        -------
        list[Personnage]
            Retourne une liste de personnages dont le niveau est supérieur ou égal au
            niveau minimum requis, retourne none s'il  n'y a aucun personnage qui respecte
            la condition.
        """
        l_res = []
    ...
    def inscription_perso(self, id_perso, id_partie, pseudo_j):
        ...
        -------
        bool
            Retourne True si le personnage a bien été créé, false sinon. Notifie à la
            base de données, le changement réalisé.
        """
