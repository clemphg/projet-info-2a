...
class ServiceMaitreDeJeu(metaclass=Singleton):
    ...
    def verifier_nvlle_partie_possible(self, creneau):
        "Vérifie s'il est possible de créer une nouvelle partie pour le créneau voulu. Si c'est le cas, True sera retournée sinon False"
    ...
    def supprimer_partie(self, partie):
        "Permet de vérifier si la partie a été supprimée ou non et notifie le changement à la base de données. Si la partie a été supprimée, il sera retournée True sinon False"
