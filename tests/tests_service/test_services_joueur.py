...
class TestServiceJoueur(TestCase):
    ...
    def test_creation_personnage(self):
        # GIVEN
        perso = Personnage(id=None, nom="nom", age=1, race="race",
                           niveau=1, classe="classe", pseudo_j="Hilaire100")
        # WHEN
    ...
    def test_changer_classe_perso(self):
        # GIVEN
        perso = Personnage(id=1, nom="Elyanna", age=200, race="elf",
                           niveau=200, classe="enchanteresse", pseudo_j="Rebecca70")
    ...
    def test_details_partie(self):
        ...
        # THEN
        self.assertIsInstance(test, Partie)
    ...
    def test_liste_creneaux_dispos(self):
        ...
        if len(test) > 0:
            self.assertIsInstance(test[0], int)
